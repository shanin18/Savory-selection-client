  ...
  return (
    <div className="bg-warning">
      <div className="container mx-auto py-10">
        ...
        <h2 className="font-pacifico text-white text-3xl md:text-5xl">Catering</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mx-2">
          <div className="bg-white p-10 hover:shadow-2xl duration-300">
            ...
            <h4 className="text-2xl lg:text-3xl text-black  text-center mt-8 font-semibold font-pacifico">Fresh Salads</h4>
          </div>
          <div className="bg-white p-10 hover:shadow-2xl duration-300 ">
            <div className="px-10">
              <img
            ...
            <h4 className="text-2xl lg:text-3xl text-black  text-center mt-8 font-semibold font-pacifico">Biryani</h4>
          </div>
          <div className="bg-white p-10 hover:shadow-2xl duration-300 ">
            <div className="px-10">
              <img
            ...
            <h4 className="text-2xl lg:text-3xl text-black  text-center mt-8 font-semibold font-pacifico">Desserts</h4>
          </div>
          <div className="bg-white p-10 hover:shadow-2xl duration-300 ">
            <div className="px-10">
              <img
            ...
            <h4 className="text-2xl lg:text-3xl text-black  text-center mt-8 font-semibold font-pacifico">Fish Items</h4>
          </div>
        </div>
      </div>
    </div>
