      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="font-montserrat">
            ...
            Here are the key differences between these two types of components:{" "}
            <br />
            Controlled components are often more customizable than uncontrolled
            components, because developers can modify them to suit their needs.
            Uncontrolled components can be more challenging to work with,
            because their behavior may be unpredictable or hard to control.
            Controlled components can be easier to test and debug than
            uncontrolled components, because the developer has more control over
            their behavior. Uncontrolled components are often simpler to use,
            because the developer doesn't need to worry about configuring them
            or managing their state.
          </p>
        </div>
        <div>
          <h3 className="text-2xl font-bold font-montserrat mb-3">
          ...
          <p className="font-montserrat">
            React PropTypes is a way to validate the types of props passed to a
            component in React. Here are the steps to validate React props using
            PropTypes:
            <br />
            <br />
            ...
            example, you can require a prop to be present by using .isRequired,
            or provide an array of possible values using .oneOf() method. Here
            are some examples:
            <br />
            <br />
            <img className="mb-3" src={img3} alt="image" />
            4. Once you've defined your propTypes object, React will
            automatically check the types of the props passed to your component
            and log a warning if any of the types do not match. You can see this
        ...
        <div>
          ...
          <p className="font-montserrat">
            ...
            hand, is a web framework that provides a set of tools and utilities
            for building web applications using Node.js.
            <br /> <br />
            ...
            resources available for building web applications using Express.js,
            such as middleware libraries, templates, and examples.
          </p>
        </div>
        <div>
          <h3 className="text-2xl font-bold font-montserrat mb-3">
          ...
          <p className="font-montserrat">
            ...
            the word "use" and allows you to encapsulate and reuse logic across
            different components. Custom hooks are a way to share logic that can
            be reused across different components without having to repeat code.
            <br />
            <br />
            Custom hooks allow developers to create reusable code that
            encapsulates logic and can be used across different components. Here
            are some reasons why you might want to create a custom hook:
            <br />
            <br />
            1. Code reuse: Custom hooks allow you to reuse code across different
            components. By creating a custom hook, you can encapsulate complex
            logic into a single function and reuse that function in different
            parts of your application. <br />
            <br />
            2. Abstraction: Custom hooks allow you to abstract away complex
            logic and provide a simpler interface for your components. By hiding
            complex logic behind a simple function call, you can make your code
            easier to understand and more maintainable. <br />
            <br />
            ...
            their core functionality and prevent them from becoming too complex.{" "}
            <br />
            <br />
